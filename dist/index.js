...
const speAttackBtn = document.getElementById('spe-attack-btn');
const abortTheMission = document.getElementById('abort-btn');
const currentHeroHp = document.querySelector(".hero-progressValue");
const currentMonsterHp = document.querySelector(".monster-progressValue");
function updateProgress() {
    currentHeroHp.textContent = `${hero.getCurrentHealth()}%`;
    currentMonsterHp.textContent = `${monster.getCurrentHealth()}%`;
    let healthHeroBar = document.getElementById('hero-hp');
    healthHeroBar.value = hero.getCurrentHealth();
    healthHeroBar.max = hero.getHealth();
    let healthMonsterBar = document.getElementById('monster-hp');
...
function displayHealthStatus(HeroHealth, MonsterHealth) {
